...
public class SVIPCommand
{
    ...
    public SVIPCommand(ToolsPlugin plugin) {
        this.plugin = plugin;
    }

    @Command(value = { "svip" }, description = "Wyświetla informacje o randze svip")
    public void handle(@Sender Player player) {
        Arrays.asList(
                ...
                " &8&l>> &f/repairall &7- Darmowa naprawa wszystkich itemow.",
                "",
                "                &7• &aPRZYWILEJE:",
                " &8&l>> &7Dostep do &5&lwszystkich &7home.",
                " &8&l>> &7Dostepne zestawy: &7gracz&7, &5&lVIP&7, &5&lSVIP",
